...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_leads_qualification_status ON leads(qualification_status);

-- Melhora contagem de movimentos por SDR (usado no WITH movement_counts)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_pipeline_history_moved_by_sdr ON lead_pipeline_history(moved_by_sdr_id);
